                  ...
                  <>
                    <div>
                      ...
                      <p className="text-sm leading-relaxed">
                        ...
                        Choose a water lily for the next level to get your
                        prize. <br />
                        Press the collect button anytime to get the prize,
                        displayed on the flower.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-sm leading-relaxed">
                        The game has 14 levels of water lilies with the
                        following payouts:
                      </p>
                    ...
                    <div>
                      ...
                      <p className="text-sm leading-relaxed mb-3">
                        The table below lists the different buttons found in the
                        game and describes their functions.
                      </p>
                      <div className="space-y-3 text-left">
                        <div>
                          <p className="font-bold">Bet</p>
                          <p className="text-sm">
                            Click + and - to change bet.
                          </p>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <p className="text-sm">
                            Click to access the game settings and game rules.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-3 text-left">
                        <div>
                          ...
                          <p className="text-sm">
                            Click to view the bet settings menu.
                          </p>
                        </div>
                        <div>
                    ...
                    <div>
                      ...
                      <p className="text-sm leading-relaxed">
                        The game has a system for recovering unfinished games.
                        <br />
                        The game session will be ended automatically after an
                        inactivity period. <br />
                        In the event of malfunction of the gaming
                        hardware/software, all affected game bets and payouts
                        are rendered void and all affected bets refunded.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-sm leading-relaxed">
                        The theoretical return to the player for this game in
                        the main game is
