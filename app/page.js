      ...
      <div className="relative w-[30%] min-w-[320px] max-w-[400px] h-[100vh] bg-[url('/game-img.jpg')] bg-cover bg-center shadow-xl flex flex-col overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/85 text-white z-50 animate-slideIn flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-4 text-center space-y-6">
            <div>
              <h2 className="text-yellow-300 font-bold mb-2">INFORMATION</h2>
              <p className="text-sm leading-relaxed">
                Frog Princess is an engaging game where you guide a frog to the end of
                each level while avoiding falling drops. With each level, the challenge
                increases. The bet cannot be changed during a currently running game
                round.
                <br />
          ...
          <div className="flex items-center justify-around bg-black/90 py-3">
            ...
            <button className="text-white text-2xl">ℹ️</button>
            <button className="text-yellow-500 text-2xl">⚙️</button>
            <button
